...
class HomeController extends GetxController {
  ...
  void fetchData() async {
    ...
    insuranceTypes.assignAll([
      InsuranceType(id: "car", name: "تأمين السيارات", icon: Icons.directions_car_filled),
      InsuranceType(id: "health", name: "التأمين الصحي", icon: Icons.local_hospital),
      InsuranceType(id: "life", name: "تأمين الحياة", icon: Icons.family_restroom),
      InsuranceType(id: "travel", name: "تأمين السفر", icon: Icons.flight_takeoff),
      // ... وهكذا لباقي الأنواع
    ]);
